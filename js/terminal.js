(function () {
    ...
    terminal.initialize = function() {
        var fore = localStorage.getItem("fore") === false ? "white" : localStorage.getItem("fore");
        var back = localStorage.getItem("back") === false ? "black" : localStorage.getItem("back");
    ...
    function internalSetDefaultForeground(color) {
        ...
        $("#anchor-style").html("a:link{color:" + color + "}a:hover{color:" + color + "}a:active{color:" + color + "}a:visited{color:" + color + "}");
        defaultForegroundColor = color;
    }

    function internalSetDefaultBackground(color) {
